 ...
 * @author Ayush Jain
 */
@WebServlet(urlPatterns = {"/AdminRequest"})
public class AdminRequest extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String UserID1 = request.getParameter("adminrequest1");
        String UserID2 = request.getParameter("adminrequest2");
