...
.table-wrap {
  ...
  overflow-y: auto;
        ...
        <title>Internet Banking | Employee Panel</title>
    </head>
    <body>
            ...
            <div class="card">
                ...
                <div class=""card-body">
                    <nav class="navbar navbar-light bg-secondary justify-content-between">
                        ...
                        <a class="navbar-brand" style="color: white;">Employee Panel</a>
                ...
                <div class="col-2">
                    <div class="card rounded-0">
                        ...
                        <div class="list-group" id="list-tab" role="tablist">
                            <a class="list-group-item list-group-item-action active rounded-0" id="list-account-list" data-toggle="list" href="#list-account" role="tab" aria-controls="account">Account Details</a>
                            <a class="list-group-item list-group-item-action rounded-0" id="list-request-list" data-toggle="list" href="#list-request" role="tab" aria-controls="request">Request For Admin</a>
...
<% 
                ...
                if(user != null)
                {
                    ...
                    while(resultSet.next())
                    {
                       %><tr>
                            ...
                            <td><button class="btn btn-primary" data-toggle="modal" data-target="#update-<%=resultSet.getString("AccountNumber") %>-update" >Update</button></td>
                            <td>
        ...
        catch(Exception ex)
        {
            out.println("Exception :"+ex.getMessage());
                        ...
                        <div class="tab-pane fade" id="list-request" role="tabpanel" aria-labelledby="list-loan-list">
                            <div class="card">
                                <h2 class="card-header text-center">Request for Admin</h2>
                                <div class="card-body">
                                    <form class="container" action="LoanRequest" method="post">
                                    ...
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-10 mb-3">
                                            <label for="Id">ID Proof Number</label>
                                            <input type="text" class="form-control" name="IDProofNumber"  placeholder="ID Proof Number" required>
                                        </div>                                                          
                                    </div>
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-10 mb-3">
                                    ...
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-10 mb-3">
                                            <button class="btn btn-md btn-primary" type="submit">Request for Admin</button> 
                                        </div>                  
                                    </div>
                                   </div>       
                                </div>
                       ...
                       %><tr>
                            ...
                            <td>
                                <form action="LoanRequest" method="post">
                                    <button class="btn btn-primary" value="<%=resultSet.getString("AccountNumber") %>" name="loan3">Accept</button>
                                <button class="btn btn-primary" value="<%=resultSet.getString("AccountNumber") %>" name="loan4">Reject</button>
                                </form>
                            </td>
                       </tr>
                      <% 
        ...
        try
        {
                if(user != null)
                {
                    ...
                    {
                       %>                                            
                        <div class="modal fade" id="list-<%=resultSet.getString("AccountNumber")%>-list" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Transaction Details Account - <%=resultSet.getString("AccountNumber") %></h5>
                      ...
                      %>
                        <div class="modal fade" id="update-<%=resultSet.getString("AccountNumber")%>-update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Update Account - <%=resultSet.getString("AccountNumber") %></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                                 ...
                                 <form class="container" action="UpdateDetails" method="post">
                                     <div class="form-row justify-content-around">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="Name" value="<%=resultSet.getString("AccountHolderName")%>" placeholder="Name" required>
                                        </div>                  
                                    </div>   
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-12 mb-3">
                                            <label for="Account Number">Account Number</label>
                                            <input type="text" class="form-control" name="AccountNumber" value="<%=resultSet.getString("AccountNumber")%>" placeholder="ID Proof Number">
                                        </div>
                                    </div>    
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-12 mb-3">
                                            <label for="Uname">User ID</label>
                                            <input type="text" class="form-control" name="UserID" value="<%=resultSet.getString("UserID")%>" placeholder="User ID" required>
                                        </div>                                           
                                    </div>
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-12 mb-3">
                                    ...
                                    <div class="form-row justify-content-around">
                                        <div class="col-md-12 mb-3">
                                            <button class="btn btn-md btn-primary" type="submit" value="1" name="update">Update</button> 
                                        </div>                  
                                    </div>
                                   </form> 
